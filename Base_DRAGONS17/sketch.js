...
function setup() {
  try {
    console.log("Base_DRAGONS17: setup() start");
    INIT2(800);
    LPRINT(`M${int(X0)},${int(Y0)}`);
  } catch (e) {
    console.error("Base_DRAGONS17 setup error:", e);
    // fallback: create canvas directly so something renders
    createCanvas(800, 800);
    background(220);
    textSize(12);
    fill(0);
    text("Error initialising INIT2 — check console", 20, 40);
    return;
  }
